...
const Footer = () => {
  return (
    <footer className="footer">
      ...
      <p>Copyright &copy; 2024 Mr. Lokesh Bansal || All Rights Reserved</p>
      <div className="row">
        <div className="col">
          <ul className='flex mt-3'>
            ...
            <li className='mt-10'>
              <p className='mt-2'>Mr. Lokesh Bansal</p>
              <p>- Vastu Expert</p>
            </li>
          </ul>
        </div>
        <div className="col">
          <ul className="social mt-5">
            <li>
              <img src="/Footer/Youtube.webp" className='h-[60%] w-[60%]' alt="" />
            </li>
            <li>
            <img src="/Footer/Instagram.png" alt="" />
            </li>
            <li>
            <img src="/Footer/Facebook.png" className='h-[70%] w-[70%]' alt="" />
            </li>
            <li>
            <img src="/Footer/X.png" className='h-[50%] w-[50%]' alt="" />
            </li>
          </ul>
        </div>
      </div>
